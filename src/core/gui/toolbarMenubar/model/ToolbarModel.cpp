...
const char* TOOLBAR_INI_HEADER =
        ...
        "SPACE,PLAY_OBJECT,EDITOR_ONLY,\n"
        "       "
        "HAND,SETSQUARE,COMPASS,SELECT_FONT,FONT_PRESET_1,FONT_PRESET_2,FONT_PRESET_3,FONT_PRESET_4,AUDIO_RECORDING,"
        "AUDIO_PAUSE_PLAYBACK,AUDIO_STOP_PLAYBACK,AUDIO_SEEK_"
